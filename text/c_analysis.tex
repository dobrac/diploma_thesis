...
\begin{lstlisting}[language=protobuf, caption={gRPC-Gateway Annotations~\cite{grpc-gateway}}, label={lst:grpc-gateway-annotations}]
...
\begin{lstlisting}[language=yaml, caption={gRPC-Gateway Configuration File~\cite{grpc-gateway}}, label={lst:grpc-gateway-configuration}]
...
- can call gRPC requests
- doesn’t include pregenerated web documentation
- application, not website
- Loads services using gRPC server reflection
