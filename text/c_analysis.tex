...
\subsubsection{F4 -- Show comments for services, methods, message types, and enum types}
...
\subsubsection{F6 -- Execution of methods with unary requests}
...
\subsubsection{F11 -- Response headers and trailers}
The website should show response headers and trailers.

\subsubsection{F12 -- Response message}
...
\subsubsection{F21 -- Options should be shown}
...
The other is the API developer, who is generating the static website from the .proto files or gRPC reflection.
