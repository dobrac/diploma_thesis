...
\functional{Generate website from gRPC reflection}
...
\textbf{Primary Actor:} API Developer\\
\textbf{Secondary Actor:} Developer\\
\textbf{Preconditions:} The API Developer has the .proto files ready.\\
\textbf{Postconditions:} The website is generated.\\
\textbf{Main Scenario:}
\begin{enumerate}
    \item The API Developer starts the generator.
    \item The generator reads the .proto files.
    \item The generator generates the website.
    \item The website is ready for the Developer.
\end{enumerate}
\textbf{Extensions:}
\begin{enumerate}
    \item[3a.] The generator fails to read the .proto files.
    \item[3b.] The generator fails to generate the website.
\end{enumerate}

\usecase{Generate Website from gRPC Reflection}

\usecase{Host the Website}
