...
\subsubsection{F1 -- List services and methods}
...
\subsubsection{F2 -- List messages}

\subsubsection{F3 -- List enums}

\subsubsection{F4 -- Show comments for services, methods, messages, and enums}

\subsubsection{F5 -- Show comments for fields}

\subsubsection{F6 -- Execution of methods with unary, client streaming, server streaming, and bidirectional requests}

\subsubsection{F7 -- Execution of methods with server streaming requests}

\subsubsection{F8 -- Request body message input}

\subsubsection{F9 -- Input form validation for the correct message structure}

\subsubsection{F10 -- Request metadata input}

\subsubsection{F11 -- Response headers and trailers display}

\subsubsection{F12 -- Response message display}

\subsubsection{F13 -- Support for oneof fields}

\subsubsection{F14 -- Support for map fields}

\subsubsection{F15 -- Support for repeated fields}

\subsubsection{F16 -- Support for nested messages}

\subsubsection{F17 -- Support for well-known types}

\subsubsection{F18 -- Generate website from .proto files}

\subsubsection{F19 -- Generate website from gRPC reflection}

\subsubsection{F20 -- Global metadata and authorization}

\subsubsection{F20 -- }

\subsection{Non-Functional}

\subsubsection{N1 -- Static Website}
...
\subsubsection{N3 -- Input as Form or JSON}
...
One is the developer, who is using the website to explore and interact with the gRPC services.
The other is the system itself, which is generating the static website from the .proto files or gRPC reflection.
