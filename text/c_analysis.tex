...
\begin{figure}[hbt!]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.8\textwidth]{images/grpc-metadata.pdf}
...
\begin{figure}[hbt!]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.8\textwidth]{images/grpc/wombat.png}
...
\begin{itemize}
    ...
    \item no support for documentation comments~\cite{grpc-wombat}.
\end{itemize}
